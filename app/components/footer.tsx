  ...
  return (
    <div className="h-80 px-4 flex flex-col justify-between">
      ...
      <div className="w-full py-3 flex flex-col-reverse md:flex-row md:justify-between md:items-center">
        <p className="md:py-10 text-base font-normal text-zinc-500 dark:text-zinc-500">
          Copyright &copy; {new Date().getFullYear()}. Made by{" "}
          <a
            href="/"
            className="inline not-italic font-normal text-zinc-950 dark:text-zinc-100"
          >
            bawuahboakye
          </a>
        </p>
        <nav className="w-40 md:py-10 py-3">
          <ul className="w-full flex justify-between items-center text-base font-normal ">
