    ...
    <>
      ...
      <section className="w-full max-h-min px-5 py-10">
        <motion.div
          ...
          className="max-w-3xl mt-20 mb-48 mx-auto flex flex-col items-center"
        >
          <h3 className="w-auto font-semibold text-md py-2 text-zinc-500 self-start">
            What I am doing now:
          </h3>
          {/* <h1 className="max-w-3xl text-3xl md:text-6xl font-black text-balance">
            Working on 1 web app, 2 websites, 1 brand identity design, building
